...
Examples:
    TONGUE_BACKEND_URL=http://my-backend:8000 uv run python -m tongue_frontend.app
    GRADIO_SERVER_NAME=127.0.0.1 GRADIO_SERVER_PORT=8080 uv run python -m tongue_frontend.app
"""
